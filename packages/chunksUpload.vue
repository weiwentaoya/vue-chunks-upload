  ...
  methods: {
    ...
    sendRequest(chunkForms) {
      ...
      return new Promise((resolve, reject) => {
        ...
        const start = () => {
          ...
          SERVER.post(this.uploadFileUrl, form, {
            onUploadProgress: (Event) => {
              this.chunks[form.index].progress = Number(
    ...
    postProgress() {
      const uploadProgress =
        this.chunks.filter((el) => el.progress === 100).length /
        this.chunks.length;
